      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <motion.div variants={cardVariants} className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
                <span className="bg-slate-900 text-white text-[9px] px-2 py-0.5 rounded font-black uppercase tracking-tighter">Level 4 Clearance</span>
            </div>
            <h1 className="text-3xl font-black text-slate-900 tracking-tight">Admin Console</h1>
            <p className="text-slate-500 font-medium italic">Grambasket Infrastructure Management</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <motion.div variants={cardVariants} className="lg:col-span-4">
            <div className="bg-white border border-slate-200 rounded-[2.5rem] shadow-xl shadow-slate-300/30 p-8 sticky top-10">
              ...
              <div className="relative w-36 h-36 mx-auto mb-6">
                ...
                />
                <div className="absolute inset-2 bg-slate-900 rounded-[2.5rem] overflow-hidden border-4 border-white shadow-2xl flex items-center justify-center">
